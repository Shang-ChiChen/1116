...
String htmlContent = "\
  <!DOCTYPE html>\
   <html>\
    <head>\
      <style>\
          body{background: #36bf36; display: flex; flex-direction: column; justify-content:center;align-items: center;}\
            label { background: #FF0000; width: 500px; height: 250px; margin: 20px; font-size: 72pt; text-decoration: none;}\
           a { background: #FF0000; width: 500px; height: 250px; margin: 20px; font-size: 72pt; text-decoration: none;}\
      </style>\
    </head>\
    <body>\
